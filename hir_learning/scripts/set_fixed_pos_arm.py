...
def move_pos():
    ...
    elbow_pub = rospy.Publisher('/elbow_pitch_controller/command', Float64, queue_size=5)
    shoulder_pub = rospy.Publisher('/shoulder_pitch_controller/command', Float64, queue_size=5)
    wrist_pub = rospy.Publisher('/wrist_pitch_controller/command', Float64, queue_size=5)
    joint = Float64()
